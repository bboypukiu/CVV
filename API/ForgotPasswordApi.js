  ...
  guitinnhan = async () => {
    ...
    if (sodt != '') {
      if (sodt == sodt) {
        ...
        await fetch(
          'http://222.252.26.108:8889/user-m-service/shipper/reset-password?phone=',
          {
            method: 'PUT',
            headers: {
    ...
    username:this.state.sodt,
        ...
        alert('số điện thoại bạn nhập sai');
      }
    } else {
