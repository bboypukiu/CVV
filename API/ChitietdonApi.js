...
async chitiet(){
  const {orderId ,tennguoinhan, sdtnguoinhan, diachinguoinan,tenshop, sdtshop, xa, huyen, tinh} = this.props.route.params
const chitiet='http://222.252.26.108:8889/api/app-shipper/order/detail?orderId='+orderId;
console.log(chitiet)
if(orderId!= ''){
  if(orderId == orderId){
    fetch(chitiet,{
...
const {orderId, tennguoinhan, sdtnguoinhan, diachinhan, tenshop, sdtshop, xa, huyen, tinh} =this.props.route.params
  return (
