  ...
  nhandon = async () => {
    ...
    if (donnhan != '') {
      ...
      var response = await fetch(
        'http://222.252.26.108:8889/api/app-shipper/order/updateShipper?shipmentId=' +
          donnhan,
        {
          method: 'POST',
          headers: {
    ...
    return (
        ...
        <TouchableHighlight>
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Text style={{fontSize: 15}}>Địa Chỉ Nhận :</Text>
              <Text style={{fontSize: 15}}> {this.props.diachinhan}</Text>
            </View>
          </View>
          </TouchableHighlight>
        ...
        <View
          ...
          <TouchableHighlight
            underlayColor=""
            onPress={() => {
              Linking.openURL(this.props.sdtshop);
            }}>
            <View style={{flexDirection: 'row'}}>
          ...
          <TouchableHighlight underlayColor="#f0f5f5" onPress={this.nhandon}>
            <View style={{flexDirection: 'row'}}>
...
export default class HomePageAPI extends Component {
  ...
  loaddt = () => {
    fetch(
      'http://222.252.26.108:8889/api/app-shipper/shipment/findShipmentNonShip',
    )
      .then((response) => response.json())
      .then((json) => {
        console.log(json);
