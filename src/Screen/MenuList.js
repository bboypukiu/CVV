      ...
      <View>
        <View
          ...
          <View style={{flexDirection: 'row', marginBottom: 5}}>
            <Text style={{color: '#6b6b47', fontSize: 12}}>
...
class Top extends Component {
  ...
  pick(a) {
    ...
    if (a == 1) {
      this.setState({
        pickcolorDanhSachDonNhan: 'white',
        pickcolorThongtinLichsu: '#ccff66',
        pickcolorbaomat: 'white',
      });
    }
            ...
            <TouchableHighlight
              ...
              <Image
                style={{
                  width: 50,
                  height: 50,
                  backgroundColor: this.state.pickcolorDanhSachDonNhan,
                  borderRadius: 25,
                }}
            ...
            <TouchableHighlight
              ...
              <Image
                style={{
                  width: 50,
                  height: 50,
                  backgroundColor: this.state.pickcolorThongtinLichsu,
                  borderRadius: 25,
                }}
