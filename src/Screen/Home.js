...
function Donmoi({navigation}) {
  return <HomePage1 navigation={navigation} />;
}
...
function Luu({navigation}) {
  return <DanhSachDonNhan navigation={navigation} />;
}
function Canhan({navigation}) {
  return <File1 navigation={navigation} />;
}
...
function ChitietDonhang({route, navigation}) {
  return <ChitietDon navigation={navigation} />;
}
