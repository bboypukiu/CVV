...
let x2 = Dimensions.get('window').height;
var khoangcach2diem = 0;
var thoigiandichuyengiua2diem = 0,
  end_address = null;
    ...
    return (
      ...
      <View   style={{backgroundColor:'white',justifyContent:'flex-start',
        ...
        {this.state.isShow == true ? (
          <FlatList
            data={this.props.parent.state.dataTimkiem}
            style={{width: 300, height: 400}}
            renderItem={({item, index}) => {
              return (
                <TouchableHighlight
                  underlayColor="#d9d6d2"
                  onPress={() => {
                ...
                latitudeend:item.geometry.location.lat,
                    ...
                    this.props.parent.getDirections(
                      this.props.parent.state.latitudeme,
                      this.props.parent.state.longitudeme,
  ...
  render() {
    return (
      <RBSheet
        ...
        onClose={() => {
          this.props.parent.setState({
            bottomchiduong: !this.props.parent.state.bottomchiduong,
...
export default class Map extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      timkiem: '',
      latitude: 20.9806175,
      latitudeme: 20.9806175,
      latitudeend: 0,
      longitude: 105.7869923,
      longitudeme: 105.7869923,
      longitudeend: 0,
      // vị trí cửa hàng
      cuahang: [
        {latitude: 20.9805409, longitude: 105.7878986},
        ...
        {latitude: 21.00185, longitude: 105.817491},
  ...
  location() {
    GetLocation.getCurrentPosition({
      ...
      .then((location) => {
        this.setState({
          latitudeme: location.latitude,
          longitudeme: location.longitude,
  ...
  async getDirections(st1, st2, st3, st4) {
    ...
    try {
      var url =
        ...
        ',' +
        st4 +
        '&key=AIzaSyCU_ap21k3SyokVT2rVjTRLnvwJKNH-1Zw';
  ...
  render() {
      ...
      <View style={{flex: 1}}>
        <MapView  style={{flex: 1}}
          ...
          <MapView.Marker
            coordinate={{
              latitude: this.state.latitudeme,
          ...
          {parseFloat(this.props.latitude1) ? ( // vi tri cua hang hoac nguoi nhan chon chi duong
            <MapView.Marker
              coordinate={{
                latitude: parseFloat(this.props.latitude1),
